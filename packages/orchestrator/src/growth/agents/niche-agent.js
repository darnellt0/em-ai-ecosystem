...
exports.runNicheAgent = runNicheAgent;
/**
 * Get sample Q&A data
 */
function getSampleQA(ctx) {
    return {
 ...
 */
function discoverThemes(qa) {
    // Mock: create themes based on input
    const themes = [
        {
            name: 'Purpose-Driven Leadership Coaching',
            description: 'Helping purpose-driven entrepreneurs and founders align their leadership with authentic values and create lasting impact.',
            keywords: ['leadership', 'purpose', 'authenticity', 'coaching', 'founders'],
            confidence: 0.87,
        },
        {
            name: 'Community-Centered Movement Building',
            description: 'Building sustainable communities that empower individuals to grow and create meaningful change together.',
            keywords: ['community', 'empowerment', 'movements', 'sustainability', 'growth'],
            confidence: 0.79,
        },
        {
            name: 'Strategic Impact Facilitation',
            description: 'Facilitating strategic planning processes that align business goals with social impact and personal values.',
 ...
 * Run Niche Agent
 */
async function runNicheAgent(ctx) {
...
//# sourceMappingURL=niche-agent.js.map