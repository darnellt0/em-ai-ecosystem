...
exports.runMindsetAgent = runMindsetAgent;
/**
 * Generate compassionate reframe for a limiting belief
 */
function generateReframe(belief) {
 ...
 */
function generateAffirmation(belief, reframe) {
    // Mock implementation - in production, use OpenAI
 ...
 */
function generateMicroPractice(belief) {
    // Mock implementation - in production, use OpenAI
    const practices = [
 ...
 */
async function processBelief(belief, ctx) {
 ...
 */
function generateWeeklySnapshot(entries, ctx) {
    const now = new Date();
 ...
 * Run Mindset Agent
 */
async function runMindsetAgent(ctx) {
...
//# sourceMappingURL=mindset-agent.js.map