...
exports.runRhythmAgent = runRhythmAgent;
/**
 ...
 */
function analyzeDayDensity(events, date) {
 ...
 */
function generatePauseBlocks(events, analysis) {
    const blocks = [];
 ...
 * Run Rhythm Agent
 */
async function runRhythmAgent(ctx) {
    ...
    try {
        ...
        for (let dayOffset = 0; dayOffset < 14; dayOffset++) {
            ...
            if (analysis.isDense) {
                ...
                console.info(`[RhythmAgent] Dense day detected: ${analysis.date} - suggesting ${pauseBlocks.length} pause blocks`);
            }
        }
...
//# sourceMappingURL=rhythm-agent.js.map