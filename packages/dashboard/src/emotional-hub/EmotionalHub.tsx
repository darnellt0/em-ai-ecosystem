...
import { FEATURES, EmotionalFeature } from './features';
import { FeatureCard } from './FeatureCard';
import { InteractionView } from './InteractionView';
import { Bot } from 'lucide-react';

export const EmotionalHub = () => {
  const [selected, setSelected] = useState<EmotionalFeature | null>(null);
    ...
    <div className="min-h-screen bg-space-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 py-14 relative z-10">
        <div className="flex flex-col items-center text-center gap-4 mb-10">
          ...
          <p className="text-sm uppercase tracking-[0.3em] text-slate-300/80">Deep Space Emotional Hub</p>
          <h1 className="text-3xl md:text-4xl font-semibold text-white">
            How are you really feeling today?
          </h1>
          <p className="text-slate-300 max-w-2xl">
            Explore six emotional tools designed to shift your state, build resilience, and keep you aligned.
          </p>
        </div>
